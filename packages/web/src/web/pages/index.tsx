...
import { ChevronDown, Award, Shield, TrendingUp, MapPin } from "lucide-react";
      ...
      <section ref={heroRef} className="relative h-screen min-h-[700px] overflow-hidden flex items-center">
        ...
        >
          ...
          >
            ...
            <Link href="/contact">
              <span className="inline-block px-10 py-4 border border-[#f0ece4]/40 text-[#f0ece4] text-xs tracking-[0.3em] uppercase font-medium hover:border-[#c9a96e] hover:text-[#c9a96e] transition-all duration-200 rounded-sm cursor-pointer">
