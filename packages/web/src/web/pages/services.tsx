...
const SERVICE_ICONS = [Search, BarChart3, Users];
            ...
            {services.map((svc, i) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-xs text-[#9a9085] leading-snug">{svc.title}</span>
                </motion.a>
              );
            })}
          </motion.div>
              ...
              <div className="max-w-7xl mx-auto px-6 lg:px-10">
                <div className={`grid grid-cols-1 lg:grid-cols-2 gap-16 items-center ${!isEven ? "lg:grid-flow-col" : ""}`}>
                  ...
                  >
                    ...
                    {/* Accent line */}
                    <div className={`absolute -bottom-2 left-8 right-8 h-0.5 ${ACCENT_LINES[i]} rounded-full opacity-60`} />
                  </motion.div>
            ...
            >
              ...
              >
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-[10px] tracking-[0.2em] uppercase text-[#5a554f]">Active Mandates</span>
                </div>
                <p className="font-['Cormorant_Garamond'] text-2xl text-[#f0ece4]">7 Live</p>
                <p className="text-xs text-[#9a9085] mt-1">Across 3 asset classes</p>
              </motion.div>

              {/* Check list overlay */}
              <div className="absolute top-6 right-6 bg-[#0C1428]/80 backdrop-blur-sm border border-[#1e2d45] rounded-xl p-4 hidden lg:block">
                {["Confidential", "Conflict-free", "Fee-transparent"].map((item, i) => (
