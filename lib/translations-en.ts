...
export const en = {
  ...
  home: {
    ...
    searchAllLocations: "All Locations",
    ...
    featuredEyebrow: "New developments",
    featuredTitle: "Projects across Yerevan",
    featuredSubtitle:
      "Residential complexes at different stages — from early sales to buildings nearing completion.",
    ...
    heroHeadline: "Find Your Next Property in Armenia",
    heroSubline: "Browse new developments, compare units, and speak to an agent in minutes.",
    heroCtaAgent: "Call Agent",
    trustYears: "25+",
    trustYearsLabel: "Years experience",
    trustListings: "Active listings",
    trustLocations: "Locations",
    whyMinimalTitle: "Why buyers choose us",
    whyMinimal: [
      { title: "Verified properties", desc: "Every listing comes from a developer we represent." },
      { title: "Direct developer access", desc: "Buy at source pricing with full transparency." },
      { title: "Best market prices", desc: "No middleman markup on new construction." },
      { title: "Fast response", desc: "Call or WhatsApp — we reply within hours." },
    ],
  ...
  owner: {
    ...
    bio: "I help families and investors find the right new-build apartment in Yerevan — directly from developers, with honest advice and fast follow-up. No pressure, no mystery fees. Just real projects and a direct line when you need answers.",
    cta: "Get in touch",
  },
  partner: {
  ...
  about: {
    pageTitle: "About CasaGroup",
    pageSubtitle: "We help families and investors buy new apartments in Yerevan — directly from developers we represent.",
    whyEyebrow: "Why CasaGroup?",
