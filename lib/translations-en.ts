...
export const en = {
  ...
  developerDetail: {
    ...
    salesJourneyMore: "More details",
    salesJourneyFloor: "Floor {n}",
    salesJourneyBuilding: "Building",
    salesJourneyBack: "Back",
    salesJourneyEmptyMap: "Interactive map coming soon.",
  ...
  admin: {
    ...
    salesMode: "Sales journey entry",
    salesModeHint: "Where buyers start when choosing an apartment on the public site.",
    salesModeMaster: "Master map (full funnel)",
    salesModeComplex: "Complex map",
    salesModeBuildings: "Building cluster",
    salesModeFloors: "Building + floors",
    salesModePlans: "Plans only",
    sectionSalesMaps: "Sales map stages",
    salesMapsHint: "Nested aerial maps (master → complex → buildings). Hotspots link to a child stage or a building.",
    salesMapAddRoot: "Add root stage",
    salesMapAddChild: "Add child stage",
