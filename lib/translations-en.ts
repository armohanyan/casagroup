...
export const en = {
  ...
  admin: {
    ...
    sectionBuildings: "Buildings & neighborhoods",
    buildingsHint: "Add a building with floor plates, or a neighborhood with land, price, photos, and houses.",
    buildingsStep1: "Choose type: Building or Neighborhood.",
    buildingsStep2: "For a building: add floors, upload the floor plan, and map apartment zones.",
    buildingsStep3: "For a neighborhood: fill in land, price, and photos — then add houses (not floors).",
    buildingsStep4: "Duplicate a floor to reuse a building layout; cloned apartment numbers stay empty.",
    ...
    drawLandPlotHint:
      "Click the image to place polygon points around the land plot. Finish with at least 3 points.",
    ...
    hotspotDrawHint: "Click the image to place polygon points around the apartment. Finish with at least 3 points.",
    hotspotFinish: "Finish zone",
    hotspotUndo: "Undo point",
    hotspotClear: "Clear draft",
    hotspotRemove: "Remove",
    hotspotNoApartments: "Assign apartments to this building first",
