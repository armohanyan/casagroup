...
export const en = {
  ...
  admin: {
    ...
    buildingsHint: "Create buildings/blocks, attach floor plate images, and map apartments on each floor.",
    buildingsStep1: "Add building → then click “Add floor”.",
    buildingsStep2: "Upload the building floor plan image for that floor.",
    buildingsStep3: "Draw apartment zones on the image (hotspots).",
    buildingsStep4: "Duplicate a floor to reuse its layout; cloned apartment numbers stay empty.",
    ...
    noBuildings: 'No buildings yet — click "Add building"',
